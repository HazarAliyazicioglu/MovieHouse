    ...
    public partial class AddUserLists : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserListFilms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserListFilms_Films_FilmId",
                        column: x => x.FilmId,
                        principalTable: "Films",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserListFilms_UserLists_UserListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserListFilms_FilmId",
                table: "UserListFilms",
                column: "FilmId");

            migrationBuilder.CreateIndex(
                name: "IX_UserListFilms_UserListId",
                table: "UserListFilms",
                column: "UserListId");
